...
-   In Rmarkdown, evaluate code chunks in the document from the project directory\
    ![](images/Screenshot 2023-10-11 at 20.14.44.png){width="299"}
...
![](images/Screenshot 2023-10-11 at 15.32.48.png){width="301"}
...
-   "**Run All Chunks Above**" and "**Run All**" are handy tools.
    ...
    ![](images/Screenshot 2023-10-11 at 18.10.42.png){width="186"}
