...
*Note:* *Please* *only use the functions we cover in this lecture for this exercise (if you choose, you may also use other functions in the `dplyr` documentation). There is [absolutely no need]{.underline} to perform any data visualization for this exercise... We will get there in later lectures.*
